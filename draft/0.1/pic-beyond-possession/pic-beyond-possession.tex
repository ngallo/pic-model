...
artifact. Boundary signing keys provide the checkpoint evidence; external
profile evidence may rely on additional trust roots. This second conclusion is relative to the
...
The anti-replay rule of Section~\ref{sec:witness} supports that construction's
additional single-consumption claim; it is not an extra conjunct of the core
...
semantic space in which carried authority may be exercised. A capability may
carry authority, but admission additionally asks whether the present occurrence
belongs to a causal continuation in which that authority and its relational
envelope remain admissible. Evidence used to establish PoR is not the semantic
relationship itself, just as evidence used to establish a profile is not the
...
\newblock PIC-X.
\newblock Source code, version \texttt{v0.2.2} (commit \texttt{d39c82c}), built
