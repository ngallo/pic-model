...
25 September 2026 against the PIC-X source prepared for release
\texttt{v0.2.3}, which builds on the \texttt{pic-protocol} crate, version
...
PIC Protocol project.
\newblock PIC-X.
\newblock Source code, version \texttt{v0.2.3}, built
