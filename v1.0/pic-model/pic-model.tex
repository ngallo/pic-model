...
All opinions and contributions are my own.
\url{github.com/ngallo}}%
}
...
\section{Terminology and Granularity}
\label{sec:terminology}
\import{./sections}{terminology.tex}

\section*{Acknowledgments}
 \textbf{Author's Note on Intellectual Property and Generative Assistance}

The \textbf{PIC Model}, its complete axiomatic system, formal definitions, and the \textbf{Structural Impossibility Claim (NO-GO Result)} represent the sole original intellectual property and core theoretical contribution of the author.
